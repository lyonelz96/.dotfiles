...
if bufferline_ok then
	...
	local bufferline_groups_ok, bufferline_groups = pcall(require, 'bufferline.groups')
	...
	if bufferline_ui_ok and bufferline_groups_ok then
		...
		nmap('<leader>bco', close_all_but_current, { desc = '[B]ufferline [C]lose [O]ther' })
		nmap('<leader>bcc', close_current, { desc = '[B]ufferline [C]lose [C]urrent' })
	end
